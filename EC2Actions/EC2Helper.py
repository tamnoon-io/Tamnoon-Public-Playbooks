...
\t\t\t  `.__.   `.__.'_. (___)(___)(___)(___)(___)  `.__.'   `.__.'  (___)(___)  `-'  (___)  `.__.'  
        ...
        '\n\n'
        '\t\t\t Executions Examples:\n'
        '\t\t\t\t python3 IAMHelper.py --profile <aws_profile> --type <The ec2 service type> --action <The action to execute> --params <the params for the action>\n'
...
if __name__ == '__main__':
    ...
    action_parmas = args.actionParmas
    ...
    if asset_type == 'snapshot':
        do_snapshot_action(session=session, dry_run=dry_run, action=action, asset_ids=asset_ids, action_parmas=action_parmas)
